                ...
                <div id="socialFields">
                    <div class="form-grid form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="twitter" class="form-input social-input"
                                placeholder="https://twitter.com/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">گیت‌هاب</label>
                            <input type="text" name="github" class="form-input social-input"
                                placeholder="https://github.com/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">تلگرام</label>
                            <input type="text" name="telegram" class="form-input social-input"
                                placeholder="https://t.me/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">واتساپ</label>
                            <input type="text" name="whatsapp" class="form-input social-input"
                                placeholder="https://wa.me/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">لینکدین</label>
                            <input type="text" name="linkedin" class="form-input social-input"
                                placeholder="https://linkedin.com/in/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">وبسایت</label>
                            <input type="text" name="website" class="form-input social-input"
