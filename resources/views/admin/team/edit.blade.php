            ...
            <form action="{{ route('update_team', $team->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $team->name }}" required class="form-input">
                    </div>
                    <div class="form-group">
                        <label class="form-label">سمت</label>
                        <input type="text" name="title" value="{{ $team->title }}" class="form-input">
                    </div>
                </div>
                ...
                <div id="socialFields">
                    <div class="form-grid form-grid-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="instagram" class="form-input social-input"
                                value="{{ $team->instagram }}" placeholder="https://instagram.com/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">توییتر</label>
                            <input type="text" name="twitter" class="form-input social-input" value="{{ $team->twitter }}"
                                placeholder="https://twitter.com/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">گیت‌هاب</label>
                            <input type="text" name="github" class="form-input social-input" value="{{ $team->github }}"
                                placeholder="https://github.com/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">تلگرام</label>
                            <input type="text" name="telegram" class="form-input social-input" value="{{ $team->telegram }}"
                                placeholder="https://t.me/...">
                        </div>
                        <div class="form-group">
                            <label class="form-label">واتساپ</label>
                            <input type="text" name="whatsapp" class="form-input social-input" value="{{ $team->whatsapp }}"
