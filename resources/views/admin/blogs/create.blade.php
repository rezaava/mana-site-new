...
@section('content')
    <style>
        ...
        .blog-service-checkbox:checked+.blog-service-label {
            border-color: var(--brand);
            background: color-mix(in srgb, var(--brand) 9%, var(--surface));
            box-shadow: 0 5px 18px color-mix(in srgb, var(--brand) 10%, transparent);
        }

        .blog-service-checkbox:checked+.blog-service-label .blog-service-check {
            background: var(--brand);
            border-color: var(--brand);
            color: var(--oncta);
        }
        ...
        <div class="blog-page-header">
            <div class="blog-page-heading">
                ...
                <div>
                    ...
                    <p class="blog-page-subtitle">اطلاعات مقاله، سئو، تصویر، تگ‌ها، سرویس‌ها و محتوای مقاله را وارد کنید.
                    </p>
                </div>
            </div>
            <a href="{{ route('blogs.index') }}" class="blog-back-top">
                <i class="fa-solid fa-arrow-right"></i>بازگشت به مقالات
            </a>
        </div>
        ...
        <div class="blog-form-card">
            <div class="blog-form-card-header">
                <h2 class="blog-form-card-header-title">
                    <i class="fa-solid fa-file-circle-plus"></i>اطلاعات مقاله
                </h2>
            </div>
                ...
                <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="blog-section">
                        ...
                        <div class="blog-form-grid">
                            ...
                            <div class="blog-form-group">
                                ...
                                <input type="number" name="reading-time" value="{{ old('reading-time') }}"
                                    class="blog-form-input" placeholder="مثلاً 5" min="1">
                            ...
                            <div class="blog-form-group">
                                ...
                                <input type="text" name="slug" value="{{ old('slug') }}" required class="blog-form-input"
                                    placeholder="مثلاً my-article" dir="ltr">
                        ...
                        <div class="blog-service-grid">
                            @forelse($services as $service)
                                <div class="blog-service-item">
                                    <input class="blog-service-checkbox" type="checkbox" name="services[]"
                                    ...
                                    <label class="blog-service-label" for="service-{{ $service->id }}">
                                        ...
                                        @if($service->number)
                                            <span class="blog-service-number">#{{ $service->number }}</span>
                                        @endif
                                    </label>
                                </div>
                            @empty
                        ...
                        <div class="blog-seo-box">
                            ...
                            <div class="blog-seo-grid">
                                <div class="blog-form-group">
                                    ...
                                    <input type="text" name="meta" value="{{ old('meta') }}" class="blog-form-input"
                                        placeholder="توضیحات کوتاه برای موتور جستجو">
                                </div>
                                <div class="blog-form-group">
                                    <label class="blog-form-label">Title Head</label>
                                    <input type="text" name="title_head" value="{{ old('title_head') }}"
                                        class="blog-form-input" placeholder="عنوان اصلی صفحه">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="blog-form-grid">
                            ...
                            <div class="blog-form-group">
                                ...
                                <select name="display_position" class="blog-form-select">
                                    ...
                                    <option value="blog-list" {{ old('display_position') == 'blog-list' ? 'selected' : '' }}>
                                        لیست مقالات — blog-list (ظرفیت: ۴)
                                    </option>
                                    <option value="blog-feature" {{ old('display_position') == 'blog-feature' ? 'selected' : '' }}>
                                        مقاله ویژه — blog-feature (ظرفیت: ۱)
                                    </option>
                                    <option value="blog-side" {{ old('display_position') == 'blog-side' ? 'selected' : '' }}>
                    ...
                    <div class="blog-form-footer">
                        <div class="blog-form-footer-info">
                            <i class="fa-solid fa-circle-info"></i>فیلدهای دارای علامت <span style="color:#ef4444">*</span>
                            الزامی هستند.
                        </div>
...
@section('scripts')
    ...
    <script>
        function addTag() {
            ...
            row.innerHTML = '<input type="text" name="tags[]" placeholder="مثلاً Laravel" class="blog-form-input-tag"><button type="button" onclick="removeTag(this)" class="blog-tag-remove"><i class="fa-solid fa-trash"></i></button>';
        ...
        const editor = new Jodit('#editor', {
            ...
            buttons: ['source', '|', 'undo', 'redo', '|', 'cut', 'copy', 'paste', 'selectall', 'removeformat', '|', 'bold', 'italic', 'underline', 'strikethrough', 'subscript', 'superscript', '|', 'font', 'fontsize', 'brush', 'paragraph', '|', 'ul', 'ol', 'outdent', 'indent', '|', 'align', 'hr', 'table', '|', 'link', 'unlink', '|', 'symbols', 'emoticons', 'specialCharacters', '|', 'print', 'fullsize', 'preview', '|', 'about'],
