            ...
            <form action="{{ route('questions.update', $question->id) }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('question', $question->title) }}" required
                            class="form-input">
                        @error('question')
                            <small class="form-error">{{ $message }}</small>
                        @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea name="answer" rows="5" required class="form-textarea"
                        style="resize: vertical;">{{ old('answer', $question->answer) }}</textarea>
                    @error('answer')
                        <small class="form-error">{{ $message }}</small>
                    @enderror
                </div>
