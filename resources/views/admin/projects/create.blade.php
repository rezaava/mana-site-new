            ...
            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="subtitle" value="{{ old('subtitle') }}" class="form-control-custom"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="client_name" value="{{ old('client_name') }}" class="form-control-custom"
                            placeholder="مثلاً: شرکت بهین فرتاک">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">سمت کارفرما</label>
                        <input type="text" name="client_role" value="{{ old('client_role') }}" class="form-control-custom"
                            placeholder="مثلاً: مدیرعامل">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">سال اجرا</label>
                        <input type="text" name="launch_year" value="{{ old('launch_year') }}" class="form-control-custom"
                            placeholder="مثلاً: ۱۴۰۲">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">مدت زمان</label>
                        <input type="text" name="duration" value="{{ old('duration') }}" class="form-control-custom"
                            placeholder="مثلاً: ۳ سال">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">لینک پروژه</label>
                        <input type="url" name="project_link" value="{{ old('project_link') }}" class="form-control-custom"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="slug" name="slug" value="{{ old('slug') }}" class="form-control-custom"
                            placeholder="slug">
                    </div>
                        ...
                        <div class="feature-box">
                            ...
                            <div style="margin-bottom:10px;">
                                ...
                                <input type="text" name="feature_title[]" value="{{ old('feature_title.' . $i) }}"
                                    class="form-control-custom" placeholder="مثلاً پنل مدیریت هوشمند">
                            ...
                            <div style="margin-bottom:10px;">
                                ...
                                <textarea name="feature_text[]" rows="3" class="form-control-custom"
                            ...
                            <div>
                                ...
                                <input type="text" name="feature_icon[]" value="{{ old('feature_icon.' . $i) }}"
                                    class="form-control-custom" placeholder="مثلاً fa-solid fa-chart-line" dir="ltr">
                ...
                <div class="tech-grid">
                    ...
                    @foreach($allTechnologies as $tech)
                        ...
                        <label
                            style="display:flex;align-items:center;gap:8px;padding:8px 12px;border:1px solid var(--border);border-radius:8px;cursor:pointer;transition:all 0.3s;">
                    ...
                    @for($i = 0; $i < 5; $i++)
                        ...
                        <div class="field-group">
                            ...
                            <input type="text" name="service_name[]" value="{{ old('service_name.' . $i) }}"
                                class="form-control-custom" placeholder="مثلاً طراحی UX/UI">
