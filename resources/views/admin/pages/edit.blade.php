            ...
            <form action="{{ route('pages.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $service->title) }}" required style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                    ...
                    <div>
                        ...
                        <input type="number" name="number" value="{{ old('number', $service->number) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <div style="margin-top:15px;">
                    ...
                    <textarea name="text" rows="4" style="
                                                width:100%;
                                                padding:10px;
                                                border-radius:8px;
                                                border:1px solid var(--border);
                ...
                <div style="
                    ...
                    <div>
                        ...
                        <input type="text" name="price_text" value="{{ old('price_text', $service->price_text) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                    ...
                    <div>
                        ...
                        <input type="text" name="support" value="{{ old('support', $service->support) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <div style="
                    ...
                    <div>
                        ...
                        <input type="text" name="contract" value="{{ old('contract', $service->contract) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <div style="
                    ...
                    <div>
                        ...
                        <input type="file" name="image" id="imageInput"
                            accept="image/jpeg,image/png,image/jpg,image/webp,image/svg+xml" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <input type="text" name="challenge_title" value="{{ old('challenge_title', $service->challenge_title) }}"
                    placeholder="عنوان چالش" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                ...
                <textarea name="challenge_text" rows="5" placeholder="متن چالش" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                ...
                <input type="text" name="solution_title" value="{{ old('solution_title', $service->solution_title) }}"
                    placeholder="عنوان راهکار" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                ...
                <textarea name="solution_text" rows="5" placeholder="متن راهکار" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                ...
                <textarea name="quote_text" rows="4" placeholder="متن نظر" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                ...
                <textarea name="cta_text" rows="4" placeholder="متن CTA" style="
                                            width:100%;
                                            padding:10px;
                                            border-radius:8px;
                                            border:1px solid var(--border);
                    ...
                    @for($i = 1; $i <= 4; $i++)
                        ...
                        <div style="
                            ...
                            <input type="text" name="state_text_{{ $i }}"
                                value="{{ old('state_text_' . $i, $state->{'text_' . $i} ?? '') }}" placeholder="عنوان" style="
                                                                                width:100%;
                                                                                margin-top:10px;
                                                                                padding:10px;
                                                                                border-radius:8px;
                            ...
                            <input type="text" name="state_value_{{ $i }}"
                                value="{{ old('state_value_' . $i, $state->{'value_' . $i} ?? '') }}" placeholder="مقدار" style="
                                                                                width:100%;
                                                                                margin-top:10px;
                                                                                padding:10px;
                                                                                border-radius:8px;
                ...
                <div id="whatReceiveContainer">
                    ...
                    @forelse($whatReceives as $index => $item)
                        ...
                        <div class="what-receive-item" style="
                                                                            border:1px solid var(--border);
                                                                            border-radius:10px;
                                                                            padding:15px;
                                                                            margin-bottom:15px;
                    ...
                    @empty
                        ...
                        <div class="what-receive-item" style="
                            ...
                            <div style="
                                ...
                                <input type="text" name="what_receive[0][title]" placeholder="عنوان" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                                ...
                                <input type="text" name="what_receive[0][icon]" placeholder="fa-comments" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                                ...
                                <input type="number" name="what_receive[0][number]" value="0" placeholder="اولویت" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                            ...
                            <textarea name="what_receive[0][text]" rows="3" placeholder="توضیحات" style="
                                                                                width:100%;
                                                                                margin-top:10px;
                                                                                padding:10px;
                                                                                border-radius:8px;
                ...
                <button type="button" id="addWhatReceive" class="btn btn-secondary" style="
                                            margin-bottom:25px;
                                            border-radius:8px;
                                        ">
                        ...
                        <div class="tech-item" style="
                            ...
                            <div style="
                                ...
                                <input type="text" name="techs[{{ $index }}][icon]"
                                    value="{{ old('techs.' . $index . '.icon', $tech->icon) }}" placeholder="fa-code" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                                ...
                                <input type="number" name="techs[{{ $index }}][number]"
                                    value="{{ old('techs.' . $index . '.number', $tech->number) }}" placeholder="اولویت" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                    ...
                    @empty
                        ...
                        <div class="tech-item" style="
                            ...
                            <div style="
                                ...
                                <input type="text" name="techs[0][text]" placeholder="مثلاً Laravel" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                                ...
                                <input type="text" name="techs[0][icon]" placeholder="fa-code" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                                ...
                                <input type="number" name="techs[0][number]" value="0" placeholder="اولویت" style="
                                                                                    width:100%;
                                                                                    padding:10px;
                                                                                    border-radius:8px;
                                                                                    border:1px solid var(--border);
                ...
                <button type="button" id="addTech" class="btn btn-secondary" style="
                                            margin-bottom:25px;
                                            border-radius:8px;
                                        ">
                    <i class="fa-solid fa-plus"></i>
                ...
                <input type="text" name="slug" value="{{ old('slug', $service->slug) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <input type="text" name="meta" value="{{ old('meta', $service->meta) }}" style="
                                                    width:100%;
                                                    padding:10px;
                                                    border-radius:8px;
                                                    border:1px solid var(--border);
                ...
                <div style="margin-top:20px;">
                    ...
                    <a href="{{ route('pages.index') }}" class="btn btn-secondary" style="text-decoration:none;">
                        بازگشت
                    </a>
