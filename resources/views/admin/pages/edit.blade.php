    ...
    <div style="background: var(--card-bg); border-radius: 12px; padding: 20px;">
        ...
        <form action="{{ route('pages.update', $service->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="title" value="{{ $service->title }}" required style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">
            </div>

            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 8px;">شماره / اولویت</label>
                <input type="number" name="number" value="{{ $service->number }}" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">
            </div>

            <div style="margin-bottom: 15px;">
                <label style="display: block; margin-bottom: 8px;">متن توضیحات</label>
                <textarea name="text" rows="5" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">{{ $service->text }}</textarea>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="iconInput" value="{{ $service->icon }}" placeholder="fa-brain" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">
                </div>
            </div>
