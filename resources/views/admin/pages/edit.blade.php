...
<div style="padding: 20px;">
    <div style="background: var(--card-bg); border-radius: 12px; padding: 20px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            <h5 style="margin: 0;">
                <i class="fa-solid fa-pen-to-square"></i> ویرایش صفحه
            </h5>
        ...
        <form action="{{ route('pages.update', $service->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 15px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $service->title) }}" required style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">
                ...
                <div>
                    ...
                    <input type="number" name="number" value="{{ old('number', $service->number) }}" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">
            ...
            <div style="margin-bottom: 15px;">
                ...
                @if($service->image_url)
                    <div style="margin-top: 10px;">
                        ...
                        <img src="{{ asset('storage/' . $service->image_url) }}" style="width: 70px; height: 70px; object-fit: cover; border-radius: 8px; margin-top: 5px;">
                    </div>
                @endif
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea name="text" rows="8" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--border); background: transparent; color: inherit;">{{ old('text', $service->text) }}</textarea>
            ...
            <button type="submit" class="btn btn-primary" style="padding: 10px 20px; border-radius: 8px; border: none; cursor: pointer;">
                <i class="fa-solid fa-save"></i> بروزرسانی صفحه
            </button>
        </form>
    </div>
</div>
